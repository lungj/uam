'''CSC120 201609 Lab 1 unit testing configuration.'''
import os
import __main__
...
preamble_cmd = ('''cp %s .;''' %
                (os.path.join(grading_dir, 'test_lab1.py'),
                ))
